<template>
  <div class="grid grid-cols-2 h-[calc(100dvh-40px)]">
    <div class="relative h-full">
      <NuxtImg :src="`/img/${category.slug}/main.jpg`" sizes="600px" class="absolute size-full object-contain"/>
      <NuxtImg :src="watermarkSrc" class="absolute size-full object-contain"/>
      <NuxtLink
...
<script setup lang="ts">
  ...
  const watermarkSrc = computed(() => `/img/watermark/${slugs[props.category.slug].watermark}.png`);
</script>
